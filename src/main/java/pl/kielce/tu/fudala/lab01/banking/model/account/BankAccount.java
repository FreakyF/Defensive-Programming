...
public class BankAccount implements IBankAccount {
	...
	public void transfer(IBankAccount targetAccount, BigDecimal amount) {
		...
		try {
			...
			addTransaction(OperationType.TRANSFER, amount, "Transfer out to account " + target.accountNumber + ". New balance: " + this.balance);

			target.balance = target.balance.add(amount);
			target.addTransaction(OperationType.TRANSFER, amount, "Transfer in from account " + this.accountNumber + ". New balance: " + target.balance);
