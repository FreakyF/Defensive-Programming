package pl.kielce.tu.fudala.server.banking.controller;
...
import pl.kielce.tu.fudala.server.banking.dto.CreateBankAccountDTO;
import pl.kielce.tu.fudala.server.banking.dto.DepositDTO;
import pl.kielce.tu.fudala.server.banking.dto.GetBankAccountDTO;
import pl.kielce.tu.fudala.server.banking.dto.TransferDTO;
import pl.kielce.tu.fudala.server.banking.dto.UpdateAccountDTO;
import pl.kielce.tu.fudala.server.banking.dto.WithdrawalDTO;
import pl.kielce.tu.fudala.server.banking.model.account.BankAccount;
import pl.kielce.tu.fudala.server.banking.model.account.IBankAccount;
import pl.kielce.tu.fudala.server.banking.model.transaction.Transaction;
import pl.kielce.tu.fudala.server.banking.persistence.IBankAccountRepository;
